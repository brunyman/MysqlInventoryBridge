	...
	public boolean setupDatabase() {
		...
		//Create tables if needed
	      ...
	      try {
	        ...
	        String accounts = "CREATE TABLE IF NOT EXISTS `" + tableName + "` (id int(10) AUTO_INCREMENT, player_uuid varchar(50) NOT NULL UNIQUE, player_name varchar(50) NOT NULL, inventory varchar(10000) NOT NULL, armor varchar(5000) NOT NULL, last_seen varchar(30) NOT NULL, PRIMARY KEY(id));";
